...
<?php 
global $base_url;
if ($is_self) print '<h2>'.t('My friends list').'</h2>';
else print '<h2>'.t($username.' friends list').'</h2>';
if(sizeof($friend_list)==0){
	if($is_self) print '<p>'.t('You don\'t have any friends yet').'</p>';
	else print '<p>'.t($username.' doesn\'t have any friends yet').'</p>';
	}
else {
