ws_privatemsg_service:

This was forked from a patched privatemsg_service. It was the privatemsg_service
in privatemsg 6.x-2.x-dev with the patch updating to services 6.x-3.x
(http://drupal.org/node/1249626)

In addition, it has had modifications to limit the amount of information
returned in a thread request.
