...
### *(New)* [Requirement](http://www.dict.org/bin/Dict?Form=Dict2&Database=*&Query=requirement)

*   [Autoload 6.x-2.x](http://drupal.org/node/1135590)

### Administrative UI

The administrative interface is at `admin/settings/mailsystem`.
...
:    [http://api.drupal.org/api/drupal/includes--mail.inc/interface/MailSystemInterface/7](http://api.drupal.org/api/drupal/includes--mail.inc/interface/MailSystemInterface/7)
