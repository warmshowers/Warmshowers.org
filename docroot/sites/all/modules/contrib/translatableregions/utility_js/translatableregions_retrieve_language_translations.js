/*
  This is a code-generation function which creates an object with all the
  required languages and the translation of "Translate to" in it.
  It did not turn out to be used, but is retained here in case we need it
  someday.

  This is not elegant AT ALL.  However, it is here due to the painstaking work
  that eventually resulted in a full object with all of the proper translations
  for "Translate to" and all of the language names for languages.  After this is
  included on a page, and runs successfully, your local environement should
  have a filled out langsObj that, from the console, you can JSON.stringify()
