...
//  'user_location_google_key',   // So that we get a different item for each subdomain
  ...
  #'pm_email_notify_subject',
  #'pm_email_notify_body',
);

# memcache/memcached settings
$conf['cache_inc'] = 'sites/all/modules/contrib/memcache/memcache.db.inc';
$conf['memcache_key_prefix'] = 'warmshowers.org';

# set cookie lifetime down to 0 and leave control with the persistent_login
# module
ini_set('session.cookie_lifetime', 0);

# When needed, set memory_limit higher (like sending mass VBO emails)
