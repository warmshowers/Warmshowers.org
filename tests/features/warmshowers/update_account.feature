...
@test
Scenario: I can add or change my personal information
...
#This one does NOT work on the current version of the site 
...
Scenario: I can add or change hosting information about preferred notice, maximum guests, distances to nearby hotels, campgrounds, bike shops, and services I am willing to provide to guests
