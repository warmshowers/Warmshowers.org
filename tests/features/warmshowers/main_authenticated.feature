...
Scenario: I can quickly edit my profile using the dashboard buttons
  When I click the Edit Profile button in the dashboard
  Then I will see the edit profile page

Scenario: I can quickly access my messages using the dashboard buttons
  When I click the Messages button in the dashboard
  Then I will see my messages page, with inbox open

Scenario: I can quickly update my location using the dashboard buttons
...
Scenario: I can quickly create a forum post
